        ...
        <div id="central">
            <div id="login">
                <form id="AltaUsuario" action="" method="post">
                    ...
                    <input type="text" id="nombre" name="Nombre" class="caja" required pattern="[a-zA-Z\s]+"
                        placeholder="Nombre">
                    <label for="apellido">Apellido:</label>
                    <input type="text" id="apellido" name="apellido" class="caja" required pattern="[a-zA-Z\s]+"
                        placeholder="Apellido">
                    <label for="apellido2">Segundo apellido:</label>
                    <input type="text" id="apellido2" name="apellido2" class="caja" required pattern="[a-zA-Z\s]+"
                    ...
                    <input type="tel" name="telefono" id="telefono" class="caja" required pattern="[0-9]+"
                    ...
                    <input type="password" name="contraseÃ±a" id="contraseÃ±a" class="caja" required
                        pattern="^(?=.*[A-Z])(?=.*\d)[A-Za-z\d]+$" placeholder="Contraseña">
